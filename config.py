...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ajajajajaas/hhhhhh")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN")
CH_US = getenv("CH_US", "c1xxv")
YAFA_CHANNEL = getenv("YAFA_CHANNEL", "https://t.me/c1xxv")
YAFA_NAME = getenv("YAFA_NAME", "• اضغط هنا للاشتراك •")
CHANNEL_SUDO = getenv("CHANNEL_SUDO", "https://t.me/c1xxv")# Fill # Fill this variable if your upstream repository is private
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/c1xxv")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/c1xxv")
CHANNEL_NAME = getenv("CHANNEL_NAME", "حسين ريال - source hassen")
